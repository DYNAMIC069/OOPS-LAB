...
// Input Format
// The first line of the input contains an integer N. The next line contains N spaceseparated
// integers (1-based index). The third line contains a single integer x,
